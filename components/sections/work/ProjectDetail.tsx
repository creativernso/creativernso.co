    ...
    >
      <div ref={contentRef} className="mx-auto max-w-[1400px] px-6 md:px-12">
        ...
        <motion.h1
          ...
          className="mt-8 font-display text-bone font-bold leading-[1.1] tracking-[-0.04em] md:whitespace-nowrap max-md:!whitespace-nowrap max-md:!visible"
          style={{
        ...
        <div className="mt-10 md:mt-12">
          ...
          >
            <h2
              ...
              className="font-display text-bone font-bold tracking-[-0.04em] md:whitespace-nowrap max-md:!whitespace-nowrap max-md:!visible"
              style={{
