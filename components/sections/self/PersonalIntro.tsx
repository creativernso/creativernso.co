  ...
  return (
    <section data-theme="dark" className="relative py-10 text-bone md:py-14">
      <div className="mx-auto max-w-[1400px] px-6 md:px-12">
        ...
        <div className="mt-6 max-w-3xl space-y-5 text-[14px] leading-[1.6] text-muted-2 [hyphens:auto] [text-align:justify] [text-wrap:pretty] md:mt-8 md:max-w-none md:text-[19px] md:leading-[1.65]">
          <p>
