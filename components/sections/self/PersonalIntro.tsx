    ...
    <section data-theme="dark" className="relative py-10 text-bone md:py-14">
      <div className="mx-auto max-w-[1400px] px-6 md:px-12">
        ...
        >
          ...
          <div className="mt-6 space-y-5 text-[13px] leading-[1.6] text-muted-2 [text-wrap:pretty] md:mt-8 md:text-[19px] md:leading-[1.65] md:[hyphens:auto] md:[text-align:justify] md:columns-2 md:gap-x-10 [&_p]:[break-inside:avoid-column]">
            <p>{t("p1")}</p>
            <p>{t("p2")}</p>
            <p>{t("p3")}</p>
          </div>
